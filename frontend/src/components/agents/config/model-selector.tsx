...
export function AgentModelSelector({
  ...
  const handleSelect = (modelId: string) => {
    ...
    if (hasAccess) {
      ...
      const isPowerModel = modelId === 'agentik/power';
      openPricingModal({
        isAlert: true,
        alertTitle: isPowerModel ? 'Upgrade to access agentiK Advanced mode' : 'Upgrade to access this model',
      });
    }
  };
  ...
  const renderModelOption = (model: any, index: number) => {
    ...
    const isPowerModel = model.id === 'agentik/power';
        ...
        <TooltipTrigger asChild>
          ...
          {!accessible && !isLocalMode() ? (
            <TooltipContent side="left" className="text-xs max-w-xs">
              <p>{isPowerModel ? 'Upgrade to access agentiK Advanced mode' : 'Upgrade to access this model'}</p>
            </TooltipContent>
          ) : isLowQuality ? (
            <TooltipContent side="left" className="text-xs max-w-xs">
