...
const agentiKAppBanners = lazy(() => 
  import('@/components/announcements/agentik-app-banners').then(mod => ({ default: mod.agentiKAppBanners }))
);
  ...
  return (
    ...
    >
      <div className="relative h-full">
        ...
        {/* agentiK App announcement banners */}
        <Suspense fallback={null}>
          <agentiKAppBanners disableMobileAdvertising={featureFlags.disableMobileAdvertising} />
        </Suspense>
