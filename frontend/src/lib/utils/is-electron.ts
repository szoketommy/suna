...
const ELECTRON_PROTOCOL = 'agentik';
...
export function isElectron(): boolean {
  ...
  // Check user agent for Electron (we append "Electron/agentiK-Desktop" in main.js)
 ...
 * - Web: returns the web URL (https://agentik.com/auth/callback)
 * - Electron: returns the custom protocol URL (agentik://auth/callback)
 */
