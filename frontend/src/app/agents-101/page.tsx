...
interface Slide {
  ...
  bulletPoints?: string[];
  accent?: string;
  diagram?: 'agent-loop' | 'agentik-stack' | 'task-types' | 'token-flow' | 'messages-array' | 'sandbox-arch' | 'tools-overview';
...
const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitle: 'CEO & COO at agentiK',
  },
  {
    id: 3,
    type: 'title',
    title: 'Demo',
    subtitle: 'Let\'s see agentiK in action',
  },
...
// agentiK Stack Diagram
const agentiKStackDiagram = () => {
  const layers = [
      ...
      {slide.type === 'diagram' && (
        <div className="w-full max-w-4xl">
          ...
          >
            ...
            {slide.diagram === 'agentik-stack' && <agentiKStackDiagram />}
