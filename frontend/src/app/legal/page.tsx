                  ...
                  {activeTab === 'imprint' ? (
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        agentiK AI Corp is responsible for the content of this
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        CAREFULLY BEFORE USING THE SERVICES OFFERED BY agentiK AI
                        Corp (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                        United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                        BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE agentiK
                      ...
                      <ul className="text-muted-foreground space-y-1 mb-6">
                        <li>
                          "Company" refers to agentiK AI Corp (701 Tillery Street
                          Unit 12-2521 Austin, Texas 78702, United States).
                        </li>
                        <li>
                          "Site" refers to the agentiK website, including any related
                          features, content, or applications offered from time to
                          time by the Company.
                        </li>
                        <li>
                          "Service" refers to the agentiK website and all related
                        ...
                        <li>
                          ...
                          Company, specifically legal@agentik.com
                        </li>
                        <li>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        <a
                          href="https://github.com/agentik-ai/agentik/blob/main/LICENSE"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-primary hover:underline"
                        >
                          github.com/agentik-ai/agentik/blob/main/LICENSE
                        </a>
                      </p>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        please write to info@agentik.com and we will process and
                      ...
                      <p className="text-muted-foreground text-balance mb-4">
                        ...
                        or by emailing us at info@agentik.com. If you cancel
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        All agentiK logos, marks, and designations are trademarks or
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        ...
                        LIMITATION, THE agentiK WEB APP AND ANY CONTENT) IS PROVIDED
                        ...
                        agentiK DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        References to our "Services" at agentiK in this statement
                      ...
                      <p className="text-muted-foreground text-balance mb-6">
                        agentiK does not collect biometric or identifying
