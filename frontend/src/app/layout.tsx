...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'agentiK Team', url: 'https://www.agentik.com' }],
  creator: 'agentiK Team',
  publisher: 'agentiK Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>agentiK: Your Autonomous AI Worker</title>
        ...
        <meta name="keywords" content="agentiK, AI Worker, Agentic AI, Autonomous AI Worker, AI Automation, AI Workflow Automation, AI Assistant, Task Automation" />
        <meta property="og:title" content="agentiK: Your Autonomous AI Worker" />
        ...
        <meta property="og:image" content="https://agentik.com/banner.png" />
        <meta property="og:url" content="https://agentik.com" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="agentiK" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="agentiK: Your Autonomous AI Worker" />
        ...
        <meta name="twitter:image" content="https://agentik.com/banner.png" />
        <meta name="twitter:site" content="@agentik" />
        <link rel="canonical" href="https://agentik.com" />
        
        {/* iOS Smart App Banner - shows native install banner in Safari */}
        {!featureFlags.disableMobileAdvertising ? (
          <meta name="apple-itunes-app" content="app-id=6754448524, app-argument=agentik://" />
        ) : null}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['agentiK', 'agentiK AI', 'agentiK: Your Autonomous AI Worker'],
              url: siteMetadata.url,
              logo: `${siteMetadata.url}/favicon.png`,
              description: siteMetadata.description,
              foundingDate: '2024',
              sameAs: [
                'https://github.com/agentiK-ai/agentiK',
                'https://x.com/agentik',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'agentiK'],
