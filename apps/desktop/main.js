...
const PROTOCOL_SCHEME = 'agentik';

// Get URL from environment variable or default to production
const APP_URL = process.env.APP_URL || 'https://agentik.com/';
...
// Register as default protocol handler for agentik://
...
function handleDeepLink(url) {
  ...
  // Convert agentik://auth/callback?code=xxx to https://agentik.com/auth/callback?code=xxx
...
function createWindow() {
  ...
  webContents.setUserAgent(webContents.getUserAgent() + ' Electron/agentiK-Desktop');
