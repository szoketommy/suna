...
2. Build a custom image:
   ...
   docker push agentik/agentik:0.1.3.28
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `agentik/agentik:___`)
...
3. Push the new version: `docker push agentik/agentik:0.1.3`
