...
class MarketplaceFilters:
    def __init__(
        ...
        self.search = search
        self.tags = tags or []
        self.is_agentik_team = is_agentik_team
...
class MarketplaceService:
    ...
    async def get_marketplace_templates_paginated(
        ...
        try:
            ...
            templates = await template_service.get_public_templates(
                is_agentik_team=filters.is_agentik_team,
                limit=limit,
                offset=offset,
    ...
    def _build_marketplace_base_query(self, filters: MarketplaceFilters):
        ...
        if filters.is_agentik_team is not None:
            query = query.eq('is_agentik_team', filters.is_agentik_team)
