...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_agentik_team:
            metadata['is_agentik_team'] = True
            metadata['agentik_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_agentik_team: {template.is_agentik_team}")
        return agent_id
