        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {
                        "type": "string",
                        "description": "Model to use for the scheduled execution. Options: 'agentik/basic' (default, free tier) or 'agentik/power' (requires paid subscription). If not specified, defaults to 'agentik/basic'."
                    }
                },
        ...
        try:
            ...
            for trigger in schedule_triggers:
                formatted = {
                    ...
                    "model": trigger.config.get("model", "agentik/basic"),
                    "is_active": trigger.is_active
                }
...
# Event trigger methods - available in all environments
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {"type": "string", "description": "Model to use for the event execution. Options: 'agentik/basic' (default, free tier) or 'agentik/power' (requires paid subscription). If not specified, defaults to 'agentik/basic'."}
                },
    ...
    async def create_event_trigger(
        ...
        try:
            ...
            # Build agentiK trigger config (same as API)
            ...
            if variables:
                agentik_config["trigger_variables"] = variables
            ...
            try:
                ...
                logger.error(f"Failed to create agentiK trigger: {e}")
                return self.fail_response(f"Failed to create agentiK trigger: {str(e)}")
            ...
            message += f"**Model**: {agentik_config['model']}\n"
